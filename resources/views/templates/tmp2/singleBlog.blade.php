                            ...
                            <div class="post-content">
                                ...
                                <div class="tag-options">
                                        ...
                                        <div class="share">
                                            ...
                                            <a href="https://www.facebook.com/sharer/sharer.php?u={{ route('singleBlog', [slug($bl->title) , $blog->id]) }}"><i class="fab fa-facebook-f"></i></a>
                                            <a href="https://twitter.com/intent/tweet?text=my share text&amp;url={{ route('singleBlog', [slug($bl->title) , $blog->id]) }}"><i class="fab fa-twitter"></i></a>
                                            <a href="#0"><i class="fab fa-pinterest-p"></i></a>
                                            <a href="http://www.linkedin.com/shareArticle?mini=true&amp;url={{ route('singleBlog', [slug($bl->title) , $blog->id]) }}&amp;title=my share text&amp;summary=dit is de linkedin summary"><i class="fab fa-linkedin-in"></i></a>
                                        </div>
                                    </div>
                    ...
                    <aside class="b-sidebar">
                        <div class="widget widget-post">
                            ...
                            <ul>
                                ...
                                @php 
                                    $dt = (new \App\Classes\TranslateFrontend())->translate($data);
                                @endphp
                                    <li>
                                    <div class="c-thumb">
                                        <a href="{{ route('singleBlog', [slug($dt->title) , $data->id]) }}">
                                            <img src="{{ get_image(config('constants.frontend.blog.post.path') .'/'. $data->value->image) }}" alt="blog">
                                        </a>
                                    </div>
                                    <div class="content">
                                        <h6 class="sub-title">
                                            <a href="{{ route('singleBlog', [slug($dt->title) , $data->id]) }}">{{__($dt->title)}}</a>
                                        </h6>
                                        <div class="meta">
