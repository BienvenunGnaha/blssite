        ...
        <div class="container">
            <div class="header-area">
                ...
                <ul class="menu">
				   ...
				   <li>
                        <a href="{{route('pronostics')}}">@lang('Pronostics')</a>
                    </li>
				   ...
				   <li>
                    ...
                    @if(Auth::user())
                        <li>
                            <a href="{{route('user.home')}}" class="header-button custom-button white">Mon compte</a>
                        </li>
                    @else
                        <li>
        ...
        <div class="container">
            <div class="row mb-50-none justify-content-center">
                <div class="col-sm-6 col-lg-8 ">
                    <div class="footer-widget widget-about ">
                        <div class="content text-center">
							<a href="http://busineu.cluster028.hosting.ovh.net/mentions_legales/">Mentions Legales</a> -
							<a href="http://busineu.cluster028.hosting.ovh.net/cguv/">Cguv</a> -
							<a href="http://busineu.cluster028.hosting.ovh.net/politique_de_confidentialite/">Politique de confidentialite</a>
						</div>							
					</ul>
                        </div>						
                    </div>
