...
<div class="row">
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <img class="mt-3 ml-auto mr-auto" src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(150)->generate('https://businesslifesport.com/user/register/BLS')) !!} ">
            <div class="mt-2 ml-auto mr-auto"><span class="font-weight-bold">QR code Inscription</span></div>
        </div>
    </div>
</div>
@endsection
