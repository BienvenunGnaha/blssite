...
@section('panel')
    <div class="row">
        <div class="col-lg-12">
        <form id="frmProducts" method="post" action="{{route('admin.edit.pronostic', $prono->id)}}">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-6 d-none">
                                <div class="form-group">
                                    <textarea class="" id="details"  name="details" required>{{$prono->details}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="button" value="{{$prono->button}}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="button_fr" value="{{$prono->button_fr}}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="conseil" rows="10">{{$prono->conseil}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="conseil_fr" rows="10">{{$prono->conseil_fr}}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <input id="bls-force-change" type="hidden" value="">
    ...
    <script>
        $(function(){
            ...
            function forceChange(){
                $('#bls-force-change').val($('#bls-force-change').val()+'a');
            }
            ...
            function restore(){
                metaData = JSON.parse($('#details').val());
                var size = metaData.length;
                //alert(size);
                for(var i = 0; i < size; i++){
                    console.log(i);
                    var md = metaData[i];
                    var uniqid = md.uniqid;
                    var sports = JSON.parse($('#bls-add-bet').attr('data-sport'));
                    ...
                    for(var j = 0; j < len; j++) {
                        var sport = sports[j];
                        var check = sport.id == md.sport ? 'checked' : '';
                        optionArray.push('<div data-id="'+uniqid+'" class="w-100 p-2 border-bottom bls-sport-option-item-wrap">\
                                                <input data-tag="'+j+'" data-id="'+uniqid+'" type="radio" id="sport_'+sport.name+uniqid+'" value="'+sport.id+'" name="'+uniqid+'" class="d-none bls-sport-radio" '+check+' required>\
                                                <label for="sport_'+sport.name+uniqid+'" data-tag="'+j+'" data-id="'+j+uniqid+'" class="bls-sport-option-item"> <img src="/assets/images/sport/'+sport.icon+'" width="40px"><span class="ml-2">'+sport.name+'</span></label>\
                                            </div>');
                    }

                    var lenbm = bms.length;
                    for(var k = 0; k < lenbm; k++) {
                        var bm = bms[k];
                        var selected = bm.id == md.bookmaker ? 'selected' : '';
                        bmOptionArray.push('<option data-id="'+uniqid+'" value="'+bm.id+'" '+selected+'>'+bm.name+'</option>');
                    }
                    var toAppend = '<div data-id="'+uniqid+'" class="row bls-row-bet border-bottom">\
                                <div class="col-md-6">\
                                    <div class="form-group">\
                                        <strong>Team 1</strong>\
                                        <input data-id="'+uniqid+'" type="text" class="form-control form-control-lg team1" value="'+md.team1+'"  placeholder="Team 1" required>\
                                    </div>\
                                </div>\
                                <div class="col-md-6">\
                                    <div class="form-group">\
                                    <strong>Team 2:</strong>\
                                        <div class="input-group">\
                                            <input data-id="'+uniqid+'" type="text" class="form-control form-control-lg team2" value="'+md.team2+'" placeholder="Team 2" required>\
                                ...
                                <div class="col-md-6">\
                                    <div class="form-group">\
                                        ...
                                        <input data-id="'+uniqid+'" type="file" class="form-control form-control-lg team1_icon"  placeholder="Team 1" >\
                                    </div>\
                                </div>\
                                <div class="col-md-6">\
                                    <div class="form-group">\
                                    <strong>Drapeau Team 2:</strong>\
                                        <div class="input-group">\
                                            <input data-id="'+uniqid+'" type="file" class="form-control form-control-lg team2_icon" placeholder="Team 2" >\
                                            <div class="input-group-append">\
                                                <span class="input-group-text"></span>\
                                            </div>\
                                        </div>\
                                ...
                                <div class="col-md-6">\
                                    <div class="form-group">\
                                        ...
                                        <input data-id="'+uniqid+'" type="text" class="form-control form-control-lg comp" value="'+md.comp+'" placeholder="Competition" required>\
                                    </div>\
                                </div>\
                                <div class="col-md-6">\
                                    <div class="form-group">\
                                    <strong>Compétition (FR):</strong>\
                                        <div class="input-group">\
                                            <input data-id="'+uniqid+'" type="text" class="form-control form-control-lg comp_fr" value="'+md.comp_fr+'" placeholder="Competition" required>\
                                            <div class="input-group-append">\
                                                <span class="input-group-text"></span>\
                                            </div>\
                                        </div>\
                                ...
                                <div class="col-md-6">\
                                    <div class="form-group">\
                                        ...
                                        <input data-id="'+uniqid+'" type="text" class="form-control form-control-lg prono_match" value="'+md.prono_match+'" placeholder="Pronotic" required>\
                                    </div>\
                                </div>\
                                <div class="col-md-6">\
                                    <div class="form-group">\
                                    <strong>Pronotic (FR):</strong>\
                                        <div class="input-group">\
                                            <input data-id="'+uniqid+'" type="text" class="form-control form-control-lg prono_match_fr" value="'+md.prono_match_fr+'" placeholder="Pronotic" required>\
                                            <div class="input-group-append">\
                                                <span class="input-group-text"></span>\
                                            </div>\
                                        </div>\
                                ...
                                <div class="col-md-6">\
                                    <div class="form-group">\
                                        <strong>Cote :</strong>\
                                        <input data-id="'+uniqid+'" type="text" min=1 class="form-control form-control-lg cote" value="'+md.cote+'" placeholder="Cote" required>\
                                    </div>\
                                </div>\
                                <div class="col-md-6">\
                                    <div class="form-group">\
                                        <strong>Meeting Date :</strong>\
                                        <input data-id="'+uniqid+'" type="text" class="form-control form-control-lg date" value="'+md.date+'" placeholder="Cote" required>\
                                    </div>\
                                </div>\
                                <div class="col-md-6">\
                                    <div class="form-group">\
            ...
            $('#bls-add-bet').click(function(){
                ...
                for(var i = 0; i < len; i++) {
                    var sport = sports[i];
                    optionArray.push('<div data-id="'+uniqid+'" class="w-100 p-2 border-bottom bls-sport-option-item-wrap">\
                                            <input data-tag="'+i+'" data-id="'+uniqid+'" type="radio" id="sport_'+sport.name+uniqid+'" value="'+sport.id+'" class="d-none bls-sport-radio" name="'+uniqid+'" required>\
                                            <label for="sport_'+sport.name+uniqid+'" data-tag="'+i+'" data-id="'+i+uniqid+'" class="bls-sport-option-item"> <img src="/assets/images/sport/'+sport.icon+'" width="40px"><span class="ml-2">'+sport.name+'</span></label>\
                                        </div>');
                }
                ...
                var toAppend = '<div data-id="'+uniqid+'" class="row bls-row-bet border-bottom">\
                            ...
                            <div class="col-md-6">\
                                <div class="form-group">\
                                    <strong>Cote :</strong>\
                                    <input data-id="'+uniqid+'" type="text" class="form-control form-control-lg cote" placeholder="Cote" required>\
                                </div>\
                            </div>\
                            <div class="col-md-6">\
                                <div class="form-group">\
                                    <strong>Meeting Date :</strong>\
                                    <input data-id="'+uniqid+'" type="text" class="form-control form-control-lg date" placeholder="date" required>\
                                </div>\
                            </div>\
                            <div class="col-md-6">\
                                <div class="form-group">\
