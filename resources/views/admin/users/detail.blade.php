    ...
    <div class="col-lg-3">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="clearfix">
                    @php
                       $pptc = pricePayToCustomer($user->id);
                    @endphp
                    <span class="float-left">Balance</span>
                    <span class="float-right text-muted">{{ $general->cur_sym }}{{ $pptc ? $pptc : 0 }}</span>
                </p>
                <p class="clearfix">
                    <span class="float-left">Refer By</span>
                    <span class="float-right text-muted">{{isset($refer->username) ? $refer->username : "None"}}</span>
                </p>
                <p class="clearfix">
                    <span class="float-left">Subscribe Plan</span>
                    <span class="float-right text-muted">{{isset($plan->name) ? $plan->name : "None"}}</span>
                </p>
                <p class="clearfix">
                ...
                <form action="{{ route('admin.users.delete', $user->id) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <input type="submit" class="btn btn-block btn-danger mt-2" value="Supprimer l'utilisateur">
                        </div>
                    </div>
                </form>
    ...
    <div class="col-lg-9">       
        <div class="card">
            ...
            <div class="row p-4">
                ...
                <div class="col-lg-4">
                    <a href="{{ route('admin.users.ref.single', $user->id) }}" class="text-white text-center btn-block">
                        <div class="card outline-info bg-info">
                            <div class="card-body">Referrals</div>
                        </div>
                    </a>
                </div>
                <div class="col-lg-4">
                    <a href="{{route('admin.users.matrix.single',['lv_no' => 1, $user->id])}}" class="text-white text-center btn-block">
                        <div class="card outline-primary bg-primary">
                            <div class="card-body">Matrix Level</div>
                        </div>
                    </a>
                </div>
            </div>
