<nav class="main-sidebar bg-default">
    ...
    <div class="navbar-brand-wrapper d-flex justify-content-start align-items-center">
        ...
        {{--<img class="logo-one" src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(150)->generate('https://businesslifesport.com/user/register')) !!} ">
        <img class="logo-two" src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(150)->generate('https://businesslifesport.com/user/register')) !!} ">--}}
    </div>
    <div id="main-sidebar">
        <ul class="nav">
            ...
            <li class="nav-item {{ sidenav_active('admin.pronostic') }}">
                <a href="/admin/bookmakers" class="nav-link">
                    <span class="menu-icon"><i class="fa fa-lightbulb-o text-facebook"></i></span>
                    <span class="menu-title">Bookmaker</span>
                </a>
            </li>

            <li class="nav-item {{ sidenav_active('admin.coupon') }}">
            ...
            <li class="nav-item {{ sidenav_active('admin.sport') }}">
                <a href="{{ route('admin.sport') }}" class="nav-link">
                    <span class="menu-icon"><i class="fa fa-lightbulb-o text-facebook"></i></span>
            ...
            <li class="nav-item {{ sidenav_active('admin.pronostic') }}">
                <a href="{{ route('admin.pronostic') }}" class="nav-link">
                    <span class="menu-icon"><i class="fa fa-lightbulb-o text-facebook"></i></span>
                    <span class="menu-title">Pronostic</span>
                </a>
            </li>
            ...
            <li class="nav-item {{ sidenav_active('admin.users*') }}">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="nav-item {{ sidenav_active('admin.matrix.up-down') }}">
                        <a class="nav-link" href="{{ route('admin.matrix.up-down') }}">
                            <span class="mr-2"><i class="fa fa-angle-right"></i></span>
                            <span class="menu-title">Update User Matrix</span>
                        </a>
                    </li>
                </ul>
            </li>
        ...
        <ul class="nav">
            ...
            <li class="nav-item {{ sidenav_active('admin.frontend*') }}">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="nav-item {{ sidenav_active('admin.frontend.rgpd.index') }}">
                        <a class="nav-link" href="{{ route('admin.frontend.rgpd.index') }}">
                            <span class="mr-2"><i class="fa fa-angle-right"></i></span>
                            <span class="menu-title">RGPD</span>
                        </a>
                    </li>

                    <li class="nav-item {{ sidenav_active('admin.frontend.translate.index') }}">
                        <a class="nav-link" href="{{ route('admin.frontend.translate.index') }}">
                            <span class="mr-2"><i class="fa fa-angle-right"></i></span>
